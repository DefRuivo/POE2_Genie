    ...
    return (
        <div className={`relative ${className}`}>
            <select
                ...
                className="w-full h-full appearance-none poe-select poe-focus-ring py-3 pl-4 pr-8 rounded-2xl leading-tight text-sm font-medium transition-all cursor-pointer"
            >
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-poe-text2">
