...
# Install OpenSSL (required for Prisma) and install Prisma CLI globally
RUN apt-get update -y && apt-get install -y openssl && rm -rf /var/lib/apt/lists/*
RUN npm install -g prisma@7.2.0

# Create symlink so prisma.config.ts can resolve 'prisma/config' from node_modules
RUN mkdir -p /app/node_modules && ln -s /usr/local/lib/node_modules/prisma /app/node_modules/prisma
