                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-3xl shadow-2xl p-6 max-w-sm w-full space-y-4 animate-in zoom-in-95 duration-200">
                        ...
                        <div className="text-center space-y-2">
                            <h3 className="text-lg font-bold text-slate-900">{t('kitchens.leaveTitle') || 'Leave Hideout?'}</h3>
                            <p className="text-sm text-slate-500">{t('kitchens.leaveConfirm') || 'Are you sure you want to leave this hideout?'}</p>
                        </div>
